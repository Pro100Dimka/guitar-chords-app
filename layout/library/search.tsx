...
const styles = StyleSheet.create({
  ...
  input: {
    ...
    color: COLORS.white,
    borderColor: COLORS.grayOpacityTiny
  },
  ...
  resultItem: {
    ...
    padding: 12,
    borderBottomWidth: 1,
    borderBottomColor: COLORS.grayOpacityTiny
  },
  resultTitle: { color: COLORS.black, fontSize: 16, fontWeight: "600" },
  resultBand: { color: COLORS.accent, fontWeight: "600", fontSize: 14 }
});
